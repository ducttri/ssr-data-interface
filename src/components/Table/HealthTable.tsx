...
export default function DataTable() {
  const rowDB: database[] = [
    {
      group: "ARM processor temperature",
      subgroup: ["Avg", "Min", "Max"],
    },
    {
      group: "SiPM board temperature",
      subgroup: ["Avg", "Min", "Max"],
    },
    {
      group: "SiPM operating voltage",
      subgroup: ["Avg", "Min", "Max"],
    },
    {
      group: "DP5 board temperature",
      subgroup: ["Avg", "Min", "Max"],
    },
    {
      group: "Detector high voltage",
      subgroup: ["Avg", "Min", "Max"],
    },
    {
      group: "Detector head temperature",
      subgroup: ["Avg", "Min", "Max"],
    },
  ];
  ...
  useEffect(() => {
    if (data) {
      const rowData = data.map((data: HealthJSON, index: number) => {
  ...
  useEffect(() => {
    if (data) {
      ...
      rowData.forEach((row: RowHealthData) => {
