import { DataJSON, HealthJSON, RowHealthData } from "@/types/types";

export function createData(id: number, data: HealthJSON) {
  return {
    id: id,
    uid: data._id,
...
export function createDataNew(
  ...
  const proData = data.processed_data;
}
...
/////// Dynamic Row Dictionary ///////

export type DynamicDictionary = { [key: string]: any };
...
export function removeKey(dictionary: DynamicDictionary, key: string): void {
  delete dictionary[key];
}

export function getValue(dictionary: DynamicDictionary, key: string): any {
  return dictionary[key];
}

export function keyExists(dictionary: DynamicDictionary, key: string): boolean {
