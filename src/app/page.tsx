      ...
      <Box sx={{ width: "100%" }}>
        <Paper sx={{ width: "100%", mb: 2 }}>
          ...
          <Typography sx={{ m: 4 }} variant="body1">
            ...
            <b> S</b>olar <b>S</b>pectrometer (IMPRESS) is a solar science
            mission that will fly a hard X-ray ({">"}
            10 keV) spectrometer on a 3U CubeSat to investigate particle
            acceleration in solar flares. IMPRESS will perform soft and hard
            X-ray (SXR and HXR, respectively) spectroscopy of solar flares in
            the rising phase of Solar Cycle 25. IMPRESS is optimized to observe
            high-cadence HXR and SXR spectra from a wide range of solar flares
            (targeting C1 to X1 class flares) without saturating the detector
            and without the need for disruptive movable attenuators. These
            measurements will be used to (1) investigate sub-second variations
            in HXR flux that strongly constrain flare acceleration timescales;
            (2) perform a mission of opportunity by co-observing HXRs from solar
            flares along with the Spectrometer/Telescope for Imaging X-rays
            (STIX) onboard Solar Orbiter, systematically studying directivity;
            and serve as a HXR monitor of flares associated with solar eruptive
            events that will drive space weather in the next solar cycle.
          </Typography>
          <Typography sx={{ m: 4 }} variant="body1">
            The IMPRESS detectors are four CeBr scintillator crystals read out
            by silicon photomultipliers and one Amptek X123 silicon drift diode.
          ...
          <Typography sx={{ m: 4 }} variant="body1">
            The data acquired by will be used to help understand how solar
            flares accelerate particles to extraordinarily high energies. Fast
            bursts undistinguishable to previous solar-dedicated HXR imagers
            (e.g. RHESSI) will be analyzed to understand their durations and
